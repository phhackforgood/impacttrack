    ...
    return (
        <div className="body-bg min-h-screen pt-12 md:pt-20 pb-6 px-2 md:px-0 font-light" >
            ...
            <div className="max-w-lg mx-auto text-center mt-12 mb-6">
                <p className="text-register">Already have an account? <a href="/auth/login" className="font-bold hover:underline">Log In</a>.</p>
            </div>
            <footer className="max-w-lg mx-auto flex justify-center text-register">
