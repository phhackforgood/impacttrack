            ...
            <main className="bg-white max-w-lg mx-auto p-8 md:p-12 my-10 rounded-lg shadow-2xl"> 
                ...
                <section className="mt-10"> 
                    <form className="flex flex-col" method="POST" action="#" onSubmit={onSubmit}> 
                        ...
                        <button className="bg-purple-600 hover:bg-purple-700 text-white font-Dmsans font-bold py-2 rounded shadow-lg hover:shadow-xl transition duration-200" type="submit">Sign In</button> 
                        {error && <p className='error'>{error}</p>} 
                    </form> 
                </section> 
            </main > 
            <div className="max-w-lg mx-auto text-center mt-12 mb-6"> 
                <p className="text-white font-Dmsans">Dont have an account? <a href="/auth/register" className="font-bold hover:underline">Sign up</a>.</p> 
            </div> 
